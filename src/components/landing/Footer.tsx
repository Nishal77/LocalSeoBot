...
export function Footer() {
  return (
    <footer className="relative bg-[#09090b] text-zinc-400 overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto border-x border-t border-b border-zinc-800 bg-[#09090b] pt-16 pb-12 px-8 relative">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-8 w-full mb-12">
          ...
          <div className="flex flex-col items-start justify-start select-none">
            ...
            <div className="flex items-center gap-2 mb-5">
              ...
              <span className="font-semibold text-lg text-white tracking-tight">RankAgent</span>
            </div>
          ...
          {/* Right Columns: Links */}
          <div className="flex flex-row gap-16 md:gap-28 md:col-span-2 justify-between sm:justify-end">

            {/* Company Column */}
            <div>
              <h3 className="text-[15px] font-semibold text-white tracking-tight mb-4 select-none">Links</h3>
              <ul className="space-y-3 text-sm">
                <li><Link href="#about" className="text-zinc-400 hover:text-white transition-colors duration-200">Features</Link></li>
                <li><Link href="#careers" className="text-zinc-400 hover:text-white transition-colors duration-200">How it works</Link></li>
                <li><Link href="#blog" className="text-zinc-400 hover:text-white transition-colors duration-200">Pricing</Link></li>
                <li><Link href="#contact" className="text-zinc-400 hover:text-white transition-colors duration-200">Sign in</Link></li>
              </ul>
            </div>

            {/* Legal Column */}
            <div>
              <h3 className="text-[15px] font-semibold text-white tracking-tight mb-4 select-none">Legal</h3>
              <ul className="space-y-3 text-sm">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-zinc-500 w-full select-none">
          <span>© {new Date().getFullYear()} RankAgent AI | All rights reserved.</span>
